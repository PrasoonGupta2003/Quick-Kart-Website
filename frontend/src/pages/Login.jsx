...
function Login() {
  ...
  return (
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white flex flex-col items-center justify-start'>
      <div className='w-[80%] flex items-center justify-start px-[30px] gap-[10px] cursor-pointer mt-[20px]' onClick={() => navigate("/")}>
      ...
      <div className='w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px]'>
        ...
        <span className='text-[16px]'>Welcome to QuickKart, Place your order</span>
      </div>

      <div className='max-w-[600px] w-[90%] h-[500px] bg-[#96969635] border-[1px] border-[#00000025] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
  ...
  <div className='relative w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]'>
    ...
    {!show&&<IoIosEye className='bottom-[56%] w-[20px] h-[20px] absolute cursor-pointer right-[5%]' onClick={()=>setShow(prev=>!prev)}/>}
    {show&&<IoMdEyeOff className='w-[20px] h-[20px] absolute cursor-pointer right-[5%]' onClick={()=>setShow(prev=>!prev)}/>}
